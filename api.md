...
- **Google Maps API** This will be utilized to recieve the current longitude and latitude of the user so that the weather api can update depending on the location of the user. 
- **Google Gemini AI API** This will be utilized to communicate to the user to understand their music preferences and recommend the genres they may like.
